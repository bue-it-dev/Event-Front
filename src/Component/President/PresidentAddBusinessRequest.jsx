...
import "../Applicant/Applicant.css"; // Import your CSS file
...
const PresidentAddBusinessRequest = () => {
    ...
    if (userConfirmed) {
      try {
        ...
        if (
          ...
          setisLoading(false);
          history.push("/president-my-business-travel-request");
        }
      } catch (err) {
        setisLoading(false);
        toast.error("An error occurred. Please try again later.", {
...
export default PresidentAddBusinessRequest;
