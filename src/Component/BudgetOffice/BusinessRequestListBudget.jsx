...
const BusinessRequestListBudgetOffice = () => {
  ...
  const GetBusinessRequest = async () => {
    try {
      const response = await axios.get(
        `${URL.BASE_URL}/api/BusinessRequest/GetBudgetBusinessRequest`,
        {
          headers: {
    ...
    rows: businessRequest.map((data, i) => ({
      ...
      action: (
        <div className="d-flex justify-content-around">
          <Link
            to={{
              pathname: "/business-request-details-budget-office",
...
export default BusinessRequestListBudgetOffice;
