...
import "../HR/HR.css";
import { UpdateBOData } from "../Requests/mutators";
import { getToken } from "../Util/Authenticate";
import { ValidatorForm, TextValidator } from "react-material-ui-form-validator";
import { toast } from "react-toastify";

const BusinessRequestDetailsBO = () => {
  ...
  const UpdateBusinessRequestAsync = async () => {
    try {
      ...
      // Pass the requestId and payload (application data) to the function
      // console.log("Payload", payload);
      await UpdateBOData(requestId, payload);
      setisLoading(false);
...
export default BusinessRequestDetailsBO;
