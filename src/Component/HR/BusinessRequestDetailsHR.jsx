...
import "./HR.css";
import { UpdateHRAllowance } from "../Requests/mutators";
import { getToken } from "../Util/Authenticate";
import { ValidatorForm, TextValidator } from "react-material-ui-form-validator";
import { toast } from "react-toastify";

const BusinessRequestDetailsHR = () => {
  ...
  const UpdateBusinessRequestAsync = async () => {
    try {
      ...
      // Send only the list of allowances, not wrapped in an object
      const payload = updatehometravelData.businessTravellrersAllowance.map(
        (travellerAllowance) => ({
      ...
      console.log("Payload (String Format):", JSON.stringify(payload, null, 2));

      // Pass only the array
      await UpdateHRAllowance(payload);
...
export default BusinessRequestDetailsHR;
