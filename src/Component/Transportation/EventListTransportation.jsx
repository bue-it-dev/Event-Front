...
import TransportationTabs from "./TransportationTabs";
const EventListTransportation = () => {
  ...
  const GetEvents = async (empID) => {
    try {
      const response = await axios.get(
        `${URL.BASE_URL}/api/EventEntity/get-eventRequestTransportation/`,
        ...
        <>
          ...
          event.statusName != "Pending" ? (
            <>
              <Link
                to={{
                  pathname: "/event-details-transportation",
                  state: {
...
export default EventListTransportation;
