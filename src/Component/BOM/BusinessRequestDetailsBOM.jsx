...
import "../HR/HR.css";
import { AddBusinessApprovalRequest } from "../Requests/mutators";
import { UpdateBOMData } from "../Requests/mutators";
import { getToken } from "../Util/Authenticate";
import { ValidatorForm, TextValidator } from "react-material-ui-form-validator";
import { toast } from "react-toastify";

const BusinessRequestDetailsBOM = () => {
  ...
  const GetBusinessRequest = async (requestId) => {
    try {
      console.log("get requestID ", requestId);
  ...
  const UpdateBusinessRequestAsync = useCallback(
    async (requestId) => {
      try {
        setisLoading(true);
        const payload = {
          requestId: requestId,
          //Allowance
          hasAllowance: updatehometravelData.hasAllowance,
          businessTravellersAllowance:
            updatehometravelData.businessTravellrersAllowance.map(
              (travellerAllowance) => ({
                rowId: travellerAllowance.rowId,
                businessTravellerID: travellerAllowance.businessTravellerID,
                businessTravellerName: travellerAllowance.businessTravellerName,
                travellerLevel: travellerAllowance.travellerLevel,
                diemPerNight: travellerAllowance.diemPerNight,
                numberOfNights: travellerAllowance.numberofNights,
                totalPerDiem: travellerAllowance.totalPerDiem,
                currency: travellerAllowance.currency,
              })
            ),
          //TravelOffice
          hasTransportation: updatehometravelData.hasTransportation,
          transportationAmount:
            updatehometravelData.transportation?.amount || 0,
          ...
          registrationFeeAmount:
            updatehometravelData.registrationFeeAmount || 0,
          ...
          //Budget Office
          budgetCode: updatehometravelData.budgetCode,
          budgetCostCenter: updatehometravelData.budgetCostCenter,
          budgetNotes: updatehometravelData.budgetNotes,
        };
        // console.log("Payload Test:", payload);
        // Pass only the array
        var reqId = requestId;
        // console.log("!!!!", payload);
        await UpdateBOMData(requestId, payload);
        setisLoading(false);
    ...
    [setisLoading, updatehometravelData]
  );
  const handleApproval = useCallback(
    async (statusId) => {
      try {
        ...
        await AddBusinessApprovalRequest(payload);
        setisLoading(false);
        if (statusId == 1) {
      ...
      <div className="col-lg-10 col-xl-8">
        ...
        <div className="card" style={{ padding: "30px" }}>
          ...
          <div className="card-body">
            ...
            <ValidatorForm className="px-md-4" /* Added more padding */>
                              ...
                              <select
                                ...
                                onChange={(e) => {
                                  ...
                                  setupdatehometravelData((prevState) => ({
                                    ...prevState,
                                    businessTravellrersAllowance:
                                      prevState.businessTravellrersAllowance.map(
                                        (allowance, i) =>
                                          i === index
                                            ? {
                                                ...allowance,
                                                travellerLevel: value,
                                              }
                                            : allowance
                                      ),
                                  }));
                              ...
                              onChange={(e) => {
                                ...
                                const numberofNights =
                                  updatehometravelData
                                    ...
                                    ?.numberofNights || 0;
                                const totalPerDiem =
                                  diemPerNight * numberofNights; // Calculate the total
                    ...
                    <tr>
                      ...
                      <td>
                        <input
                          type="number"
                          className="form-control"
                          value={updatehometravelData.accomdation?.amount || ""}
                          onChange={(e) => {
                            const value = e.target.value;
                            setupdatehometravelData({
                              ...updatehometravelData,
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 mb-4">
                      ...
                      <input
                        ...
                        id="preferredHotel"
                        name="preferredHotel"
                        value={updatehometravelData.budgetCostCenter || ""} // Adjusted to match state structure
                        onChange={(e) => {
                          const value = e.target.value;
                          setupdatehometravelData({
                            ...updatehometravelData,
              ...
              >
                ...
                Once you approve or reject this request, no further changes will
                be allowed.
              </p>
              {status == "Pending" ? (
                <>
                  <div className="row">
                    <div>
                      <button
                        ...
                        onClick={() => UpdateBusinessRequestAsync(requestId)}
                      >
...
export default BusinessRequestDetailsBOM;
