...
const HomeRequestListBOM = () => {
  ...
  const GetHomeRequests = async () => {
    try {
      const response = await axios.get(
        `${URL.BASE_URL}/api/HomeRequest/GetTravelHomeRequestBOM`,
        {
          headers: {
    ...
    rows: homerequests.map((data, i) => ({
      ...
      action: (
        <div className="d-flex justify-content-around">
          <Link
            to={{
              pathname: "/home-request-details-bom",
  ...
  return (
    <div className="my-home-requests">
      {/* <h4>Business Operation Manager Portal</h4> */}
      {/* <BOMTabs /> */}
      <BOM />
...
export default HomeRequestListBOM;
